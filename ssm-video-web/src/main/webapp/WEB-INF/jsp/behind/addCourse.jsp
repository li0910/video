...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/course/saveOrUpdate" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="courseTitle" value="${course.courseTitle}" placeholder="课程名">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="courseDesc" class="form-control" value="${course.courseDesc}" placeholder="课程描述">
            </div>
        </div>
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <div class="input-group-btn">
                        ...
                        <ul id="selectCourse" class="dropdown-menu">
                            <c:forEach items="${subjectList}" var="subject">
                                <li value="${subject.id}">
                                    <a href="#" onclick="showName(this,${subject.id},2)">${subject.subjectName}</a>
                                </li>
                            </c:forEach>
                    ...
                    <c:if test="${empty course.subjectId}">
                        <input type="hidden" class="form-control" id="courseId" name="subjectId" value="0">
                    </c:if>
                    <c:if test="${not empty course.subjectId}">
                        <input type="hidden" class="form-control" id="courseId" name="courseId" value="${course.subjectId}">
                    </c:if>
