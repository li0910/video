...
<header>
    <div class="container">
        ...
        <div id="userBlock" style="display:none;float:right">
            ...
            <a href="${pageContext.request.contextPath}/exit/outLine" id="loginout">退出</a>
            <a href="${pageContext.request.contextPath}/user/showMyProfile" id="account">${user.getEmail}</a>
        </div>
...
<div class="mask hidden" id="reg">
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form id="regForm" action="/user/loginUser">
                <h3>新用户注册</h3>
