...
<header>
    <div class="container">
        ...
        <div id="userBlock" style="display:none;float:right">
            ...
            <a href="${pageContext.request.contextPath}/exit/logOut" id="loginout">退出</a>
            <a href="${pageContext.request.contextPath}/user/showMyProfile?id=${user.id}" id="account">${sessionScope.userAccount}</a>
        </div>
